...
public class ModelResult {
    ...
    private Integer state = ModelResult.SUCCESS;
     ...
     * @param success 是否成功
     */
    public ModelResult(boolean success) {
     ...
     * @param state 状态码
     */
    public ModelResult(boolean success, Integer state) {
        this.success = success;
        this.state = state;
    }

    public ModelResult(boolean success, String msg) {
        this.success = success;
        this.message = msg;
    }

    public ModelResult(Integer state, String msg) {
        this.state = state;
        this.message = msg;
    }

    public ModelResult(boolean success, Integer state, String msg) {
        this.success = success;
        this.state = state;
        this.message = msg;
    }
    ...
    /**
     *
     * 输出ModelResult中的键值只response中，值需为json格式
     *
     * @param response
     */
    ...
    /**
     * 输出ModelResult中的键值只response中，值需为jsonp格式
     *
     * @param response
     * @param functionName
     */
     ...
     * @param ModelResult
     */
    public void addAttrbutes(ModelResult ModelResult) {
        data.putAll(ModelResult.getData());
    }
