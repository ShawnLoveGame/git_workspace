package com.he.exam.webapp.utils.codec;
...
public class CryptoUtils {
	...
	public static void main(String[] args) throws IOException {
		...
		String key = "0B3728A26ECF82AECB49501ADEC9882654FFE2C75DEC237D";
		System.out.println(key.length());
		String encode = aesEncryptToHex("1", key);
		System.out.println(encode);
		System.out.println(aesDecryptFromHex(encode, key));
		
		encode = aesEncryptToBase64("1", hexToByte(key));
		System.out.println(encode);
		System.out.println(aesDecryptFromBase64(encode, hexToByte(key)));
	}
}