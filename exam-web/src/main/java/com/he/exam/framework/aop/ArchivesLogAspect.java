package com.he.exam.framework.aop;

import com.he.exam.dao.log.BackOperateLogMapper;
import com.he.exam.framework.log.LogThread;
...
public class ArchivesLogAspect {
    ...
    private BackOperatorVO user = null;
    ...
    @Before("@annotation(com.he.exam.framework.aop.ArchivesLog)")
