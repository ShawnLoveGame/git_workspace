package com.he.exam.util.shared;

import com.he.exam.util.json.JsonUtils;
import com.he.exam.util.shared.pipline.ShardedJedisPipelineUtils;
...
public class RedisUtils {
	 ...
	 * list尾部添加元素
	 * 
	 * @see  http://redis.cn/commands/rpush.html
	 * @return list长度
	 */
...
//	}
	 ...
	 * set
	 * 
	 * @see  http://redis.cn/commands/sadd.html
	 * @return
	 */
