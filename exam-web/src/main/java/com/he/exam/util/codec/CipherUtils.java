package com.he.exam.util.codec;
...
public class CipherUtils {
     ...
     * MD5秘钥
     */
    private static final String MD5_KEY = "exam.com";
    ...
    public static String generateMACKey() {
        try {
            ...
            return TranscodeUtil.byteArrayToHexStr(secretKey.getEncoded());
    ...
    public static String HMACEncode(String data, String key) {
        ...
        try {
            ...
            mac.init(k);
            return TranscodeUtil.byteArrayToHexStr(mac.doFinal(data.getBytes()));
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    private static Key toKey(String key, String algorithm) {
        SecretKey secretKey = new SecretKeySpec(TranscodeUtil.hexStrToByteArray(key), algorithm);
        return secretKey;
    }
    ...
    private static String DESCipher(String data, String key, int mode) {
        try {
            ...
            cipher.init(mode, k);
            return mode == Cipher.DECRYPT_MODE ? new String(cipher.doFinal(TranscodeUtil.hexStrToByteArray(data))) : TranscodeUtil.byteArrayToHexStr(cipher.doFinal(data.getBytes()));
        } catch (Exception e) {
            BusinessException.throwMessage(e.getMessage());
        }
        return null;
    ...
    public static String generatePBESalt() {
        ...
        return TranscodeUtil.byteArrayToHexStr(salt);
    }
    ...
    private static String PBECipher(String data, String password, String salt, int mode) {
        try {
            ...
            PBEParameterSpec paramSpec = new PBEParameterSpec(TranscodeUtil.hexStrToByteArray(salt), 100);
    ...
    public static String generateAESKey(int keySize, String seed) {
        try {
            ...
            return TranscodeUtil.byteArrayToHexStr(key.getEncoded());
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
        }
        return null;
    ...
    private static String AESCipher(String data, String key, String algorithmParameter, int mode) {
        try {
            ...
            return mode == Cipher.DECRYPT_MODE ? new String(ecipher.doFinal(TranscodeUtil.hexStrToByteArray(data))) : TranscodeUtil.byteArrayToHexStr(ecipher.doFinal(data.getBytes()));
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    public static String RSASign(String data, String privateKey) {
        try {
            // 解密由base64编码的私钥
            byte[] keyBytes = TranscodeUtil.hexStrToByteArray(privateKey);
            ...
            signature.update(TranscodeUtil.hexStrToByteArray(data));
            return TranscodeUtil.byteArrayToHexStr(signature.sign());
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
        } catch (InvalidKeySpecException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    public static boolean RSAVerify(String data, String publicKey, String sign) {
        try {
            // 解密由base64编码的公钥
            byte[] keyBytes = TranscodeUtil.hexStrToByteArray(publicKey);
            ...
            signature.update(TranscodeUtil.hexStrToByteArray(data));
            // 验证签名是否正常
            return signature.verify(TranscodeUtil.hexStrToByteArray(sign));
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
        } catch (InvalidKeySpecException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    public static String RSADecryptByPrivateKey(String data, String key) {
        try {
            // 对密钥解密
            byte[] keyBytes = TranscodeUtil.hexStrToByteArray(key);
            // 取得私钥
            PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
            KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
            ...
            return new String(cipher.doFinal(TranscodeUtil.hexStrToByteArray(data)));
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
        } catch (InvalidKeySpecException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    public static String RSAEncryptByPublicKey(String data, String key) {
        try {
            ...
            return TranscodeUtil.byteArrayToHexStr(cipher.doFinal(data.getBytes()));
        } catch (NoSuchAlgorithmException e) {
            BusinessException.throwMessage(e.getMessage());
        } catch (InvalidKeySpecException e) {
            BusinessException.throwMessage(e.getMessage());
    ...
    private static SecretKey getDHSecretKey(String publicKey, String privateKey) {
        try {
            // 初始化公钥
            byte[] pubKeyBytes = TranscodeUtil.hexStrToByteArray(publicKey);
            KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM_DH);
            X509EncodedKeySpec x509KeySpec = new X509EncodedKeySpec(pubKeyBytes);
            PublicKey pubKey = keyFactory.generatePublic(x509KeySpec);
            // 初始化私钥
            byte[] priKeyBytes = TranscodeUtil.hexStrToByteArray(privateKey);
    ...
    public static String sign(String sign, String keyStorePath, String alias, String password) {
        try {
            ...
            signature.update(TranscodeUtil.hexStrToByteArray(sign));
            return TranscodeUtil.byteArrayToHexStr(signature.sign());
        } catch (Exception e) {
            BusinessException.throwMessage(e.getMessage());
        }
