...
public class AlikAssert {
    ...
    public static void isNotNull(Object object, String errCode,String message) {
        if (object == null) {
            BusinessException.throwMessageWithCode(errCode, message);
        }
    }
...
//     * @param message
//     */
//    public static void isNotEmpty(String str, ExceptionEnum exceptionEnum) {
//        if (StringUtils.isEmpty(str)) {
//            BusinessException.throwMessageWithCode(exceptionEnum);
//        }
//    }
    
    public static void isNotEmpty(String str, String errCode, String message) {
        if (StringUtils.isEmpty(str)) {
            BusinessException.throwMessageWithCode(errCode, message);
        }
    }
...
//     * @param message
//     */
//    public static void isNotEmpty(Collection<?> col, ExceptionEnum exceptionEnum) {
...
//     * @param message
//     */
//    public static void isNotBlank(String str, ExceptionEnum exceptionEnum) {
//        if (StringUtils.isBlank(str)) {
//            BusinessException.throwMessageWithCode(exceptionEnum);
//        }
//    }
