    ...
    var $body = $(document.body),
        ...
        getTpl = function () {
            return ['<div class="modal fade" data-backdrop="false" data-show="false" data-keyboard="false">',
                ...
                '            <div class="modal-header" style="background-color: #B86;color: #FFF;">',
    ...
    var modal,
        Proxy = function (isAlert) {
            return function () {
                ...
                var msg = typeof arguments[0] === 'string' && arguments[0] || arguments[0].content || '',
