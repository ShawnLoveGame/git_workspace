...
(function ($) {
    ...
    $.fn.editableutils = {
       ...
       **/
       ...
       /*
        returns array items from sourceData having value mapper equal or inArray of 'value'
       */
        ...
        handleEmpty: function (isEmpty) {
            ...
            */
            ...
            if(!this.options.disabled) {
                ...
                //below required if element disable mapper was changed
                if(this.isEmpty) {
                    this.$element.empty();
                    if(this.options.emptyclass) {
                        this.$element.removeClass(this.options.emptyclass);
...
(function ($) {
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/             
        placeholder: null,
        /**
        Source data for select. It will be assigned to select2 `data` mapper and kept here just for convenience.
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        initContainer: function(){
            ...
            //as template mapper is used in inputs, hide it from popover
            var t;
